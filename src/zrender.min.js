!(function(t, e) {
    ...
    function W(t, e) {
        ...
        return (
            null != e && i && i.normalizeQuery && (e = i.normalizeQuery(e)), e
        );
    }
    function N(t) {
    ...
    function _e(t, e) {
        ...
        for (L = 0; L < o.length; L++) {
            for (var p = o[L], g = 0, v = 0, _ = 0; _ < p.tokens.length; _++) {
                var y =
                        ((z = p.tokens[_]).styleName && e.rich[z.styleName]) ||
                        {},
                ...
                if ('string' == typeof T && '%' === T.charAt(T.length - 1))
                    ...
                    if (S) {
                        ...
                        C &&
                            ie((C = Jt(C))) &&
                            (T = Math.max(T, (C.width * k) / C.height));
                    }
                    var A = w ? w[1] + w[3] : 0;
                    T += A;
    ...
    function Te(t, e, i, r, n, a) {
        ...
        if (
            ...
            for (var O = 0; O < d.length; O++)
                I && e.strokeText(d[O], w, b),
                    R && e.fillText(d[O], w, b),
                    (b += p);
    }
    ...
    function Me(t, e, i, r, n) {
        ...
        for (var m = 0; m < i.lines.length; m++) {
            for (
                ...
                Ae(t, e, x, r, T, _, C, 'left'),
                    (S -= x.width),
                    (C += x.width),
                    M++;
            for (; P >= 0 && 'right' === (x = b[P]).textAlign; )
                Ae(t, e, x, r, T, _, A, 'right'),
                    (S -= x.width),
                    (A -= x.width),
                    P--;
    ...
    function Ae(t, e, i, r, n, a, o, s) {
        ...
        c && ((o = Fe(o, s, c)), (u -= i.height / 2 - c[2] - i.textHeight / 2)),
            ...
            Be(
                e,
                'shadowOffsetX',
                x(h.textShadowOffsetX, r.textShadowOffsetX, 0),
            ),
            Be(
                e,
                'shadowOffsetY',
                x(h.textShadowOffsetY, r.textShadowOffsetY, 0),
            ),
            Be(e, 'textAlign', s),
    ...
    function Le(t, e, i, r, n, a, o) {
        ...
        if (
            ...
            c
                ? xe(e, { x: r, y: n, width: a, height: o, r: c })
                : e.rect(r, n, a, o),
                e.closePath();
        }
        if (u) {
    ...
    function ui(t, e, i, r, n, a, o, s, h, l, u) {
        ...
        return (
            u && ((u[0] = ai(t, i, n, o, c)), (u[1] = ai(e, r, a, s, c))), Ba(_)
        );
    }
    function ci(t, e, i, r) {
        var n = 1 - r;
    ...
    function Di(t, e, i, r, n) {
        for (var a = 0, o = 0, s = 0, h = 0, l = 0, u = 0; u < t.length; ) {
            ...
            switch (
                ...
                case fo.Q:
                    if (i) {
                        if (ki(o, s, t[u++], t[u++], t[u], t[u + 1], e, r, n))
                            return !0;
                    } else
                        a +=
                            Li(o, s, t[u++], t[u++], t[u], t[u + 1], r, n) || 0;
                    (o = t[u++]), (s = t[u++]);
                    break;
                case fo.A:
                    var f = t[u++],
    ...
    function Qi(t) {
        ...
        for (var a in Qo)
            Qo.hasOwnProperty(a) && null != r[a] && (i[Qo[a]] = r[a]);
        return i;
    }
    function $i(t, e, i) {
        var r = e / t.width,
    ...
    function or(t, e, i) {
        (!i || ('linear' !== i.type && 'radial' !== i.type)) &&
            ('string' == typeof i && i.indexOf('NaN') > -1 && void 0,
            t.setAttribute(e, i));
    }
    function sr(t, e, i) {
    ...
    an.prototype = {
        ...
        one: function(t, e, i, r) {
            ...
            if (
                ('function' == typeof e && ((r = i), (i = e), (e = null)),
                !i || !t)
            )
                return this;
            (e = W(this, e)), n[t] || (n[t] = []);
    ...
    (jn.prototype = {
        ...
        _doAdd: function(t) {
            ...
            e &&
                e !== t.__storage &&
                (e.addToStorage(t),
                t instanceof jn && t.addChildrenToStorage(e)),
                i && i.refresh();
        },
        remove: function(t) {
            var e = this.__zr,
        ...
        delChildrenFromStorage: function(t) {
            for (var e = 0; e < this._children.length; e++) {
                var i = this._children[e];
                t.delFromStorage(i),
                    i instanceof jn && i.delChildrenFromStorage(t);
            }
        },
        dirty: function() {
    ...
    $n.prototype = {
        ...
        bind: function(t, e, i) {
            for (
                var r = this, n = i && i.style, a = !n, o = 0;
                o < Qn.length;
                o++
            ) {
                var s = Qn[o],
        ...
        za = function(t, e, i) {
            ...
            (this.handler = new cn(n, o, s, o.root)),
                (this.animation = new ma({
                    stage: { update: f(this.flush, this) },
                })),
    ...
    (lo.prototype = {
        ...
        toStatic: function() {
            ...
            t instanceof Array &&
                ((t.length = this._len),
                ho && (this.data = new Float32Array(t)));
        },
        getBoundingRect: function() {
    ...
    (qi.prototype.parse = function(t, e) {
        ...
        return (
            e.ignoreRootClip ||
                ...
                null == o ||
                r.setClipPath(
                    new Eo({ shape: { x: 0, y: 0, width: a, height: o } }),
                ),
            {
                root: r,
                width: a,
    ...
    var Go = {
        ...
        ts = Ri.extend({
            ...
            getBoundingRect: function() {
                return (
                    this._updatePathDirty(),
                    Ri.prototype.getBoundingRect.call(this)
                );
            },
        });
        ...
        if (!this._rect) {
            for (
                ...
                i.needLocalTransform() &&
                    r.applyTransform(i.getLocalTransform(es)),
                    t.union(r);
            }
            this._rect = t;
        }
        ...
        Ns = function(t, e, i) {
            ...
            if (null != n) {
                ...
                if (
                    ...
                    if (t.transform)
                        Ws.copy(e), Ws.applyTransform(t.transform), (e = Ws);
                    else {
    ...
    (pr.prototype.createElement = tr),
        ...
        (gr.prototype.add = function(t) {
            ...
            if ('linear' === t.type) e = this.createElement('linearGradient');
                ...
                if ('radial' !== t.type)
                    return En('Illegal gradient type.'), null;
        ...
        (gr.prototype.updateDom = function(t, e) {
            if ('linear' === t.type)
                ...
                if ('radial' !== t.type)
                    return void En('Illegal gradient type.');
        ...
        (_r.prototype.add = function(t) {
            ...
            return (
                ...
                e.setAttribute(
                    'id',
                    'zr' + this._zrId + '-shadow-' + i._shadowDomId,
                ),
                this.updateDom(t, e),
                this.addDom(e),
                e
        ...
        (_r.prototype.remove = function(t, e) {
            null != e._shadowDomId &&
                (this.removeDom(e), (t.style.filter = ''));
        }),
    ...
    (js.prototype = {
        ...
        _getDefs: function(t) {
            ...
            return 0 === i.length
                ? t
                    ? ((i = e.insertBefore(tr('defs'), e.firstChild))
                          .contains ||
                          (i.contains = function(t) {
                              var e = i.children;
                              if (!e) return !1;
                ...
                if (null != r)
                    if (r instanceof Xo) {
                        ...
                        if ('linear' === r.type) {
                            ...
                            var g = p[0] - d[0],
                                v = p[1] - d[1];
                            (a = (180 * Math.atan2(g, v)) / Math.PI) < 0 &&
                                (a += 360),
                                a < 1e-6 && (a = 0);
                        } else {
                            n = 'gradientradial';
        ...
        (We.prototype.brushVML = function(t) {
            ...
            if (n) {
                ...
                if (_) {
                    ...
                    D ||
                        (((D = Zs.createElement('div')).style.overflow =
                            'hidden'),
                        (this._cropEl = D));
                    var F = D.style;
                    (F.width = $s((c + (g * c) / d) * b)),
                    ...
                    (B.width = $s(b * c) + 'px'),
                        ...
                        D &&
                            D.parentNode &&
                            (y.removeChild(D), (this._cropEl = null));
                var E = '',
                    H = r.opacity;
            ...
            (Ah.drawRectText = function(t, e, i, r) {
                ...
                if ((null != a && (a += ''), a)) {
                    ...
                    if (
                        (_ &&
                            !r &&
                            (Sh.copy(e), Sh.applyTransform(_), (e = Sh)),
                        r)
                    )
                        (c = e.x), (f = e.y);
                    else {
