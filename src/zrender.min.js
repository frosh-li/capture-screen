!(function(t, e) {
  ...
  function V(t, e, i, r) {
    return (
      (i = i || {}),
      r || !Or.canvasSupported
        ? q(t, e, i)
        : Or.browser.firefox && null != e.layerX && e.layerX !== e.offsetX
  ...
  function tt(t, e, i) {
    ...
    return (
      (t[0] = r), (t[1] = n), (t[2] = a), (t[3] = o), (t[4] = s), (t[5] = h), t
    );
  }
  function et(t, e, i) {
    return (
      ...
      if ("#" !== r.charAt(0)) {
        ...
        if (-1 !== n && a + 1 === r.length) {
          ...
          switch (o) {
            ...
            case "rgb":
              return 3 !== s.length
                ? void pt(e, 0, 0, 0, 1)
                : (pt(e, ut(s[0]), ut(s[1]), ut(s[2]), h), vt(t, e), e);
            case "hsla":
              return 4 !== s.length
                ? void pt(e, 0, 0, 0, 1)
                : ((s[3] = ct(s[3])), yt(s, e), vt(t, e), e);
            case "hsl":
              return 3 !== s.length
                ? void pt(e, 0, 0, 0, 1)
                : (yt(s, e), vt(t, e), e);
        ...
        if (7 === r.length) {
          ...
          return l >= 0 && l <= 16777215
            ? (pt(e, (16711680 & l) >> 16, (65280 & l) >> 8, 255 & l, 1),
              vt(t, e),
              e)
            : void pt(e, 0, 0, 0, 1);
        }
  ...
  function Ct(t, e, i, r, n) {
    var a = t.length;
    if (1 == n) for (s = 0; s < a; s++) r[s] = St(t[s], e[s], i);
    else
  ...
  function At(t, e, i) {
    ...
    if (r !== n)
      if (r > n) t.length = n;
      else for (o = r; o < n; o++) t.push(1 === i ? e[o] : Bn.call(e[o]));
  ...
  function Lt(t, e, i, r, n, a, o, s, h) {
    ...
    if (1 == h)
      ...
      for (var u = t[0].length, c = 0; c < l; c++)
        for (var f = 0; f < u; f++)
          s[c][f] = zt(t[c][f], e[c][f], i[c][f], r[c][f], n, a, o);
  }
  function zt(t, e, i, r, n, a, o) {
    var s = 0.5 * (i - t),
      h = 0.5 * (r - e);
    return (
      (2 * (e - i) + s + h) * o + (-3 * (e - i) - 2 * s - h) * a + s * n + e
    );
  }
  function Dt(t) {
    if (l(t)) {
    ...
    if (u) {
      ...
      if (a || !m) {
        for (var k = _[u - 1], x = 0; x < u - 1; x++)
          f ? At(_[x], k, g) : !isNaN(_[x]) || isNaN(k) || p || d || (_[x] = k);
            ...
            if (0 !== r)
              if (((S = (e - v[i]) / r), h))
                if (
                  ...
                  Lt(M, C, A, P, S, S * S, S * S * S, o(t, n), g);
                else {
                  if (d)
                    (a = Lt(M, C, A, P, S, S * S, S * S * S, D, 1)),
                      (a = Bt(D));
                  else {
  ...
  function Ft(t, e, i, r, n, a, o) {
    ...
    for (var u in r)
      r.hasOwnProperty(u) &&
        (null != i[u]
          ? v(r[u]) && !l(r[u])
            ? Ft(t, e ? e + "." + u : u, i[u], r[u], n, a, o)
            : (o ? ((s[u] = i[u]), Et(t, e, u, r[u])) : (s[u] = r[u]), h++)
          : null == r[u] || o || Et(t, e, u, r[u]));
    h > 0 &&
      t
        .animate(e, !1)
        .when(null == n ? 500 : n, s)
  ...
  function Yt(t, e) {
    function i(i) {
      var s = a[i],
        ...
        c = o[i + 1];
      (o[i] = l + c),
        i === h - 3 && ((a[i + 1] = a[i + 2]), (o[i + 1] = o[i + 2])),
        h--;
      var f = Xt(t[u], t, s, l, 0, e);
      (s += f),
        0 !== (l -= f) &&
          0 !== (c = jt(t[s + l - 1], t, u, c, c - 1, e)) &&
    ...
    function n(i, r, n, a) {
      ...
      if (((t[c--] = t[h--]), 0 != --r))
        if (1 !== a) {
          ...
          if (((s = p) < 1 && (s = 1), 1 === a)) {
            for (d = (c -= r) + 1, f = (h -= r) + 1, o = r - 1; o >= 0; o--)
              t[d + o] = t[f + o];
            t[c] = l[u];
          } else {
  ...
  function te(t, e, i, r, n) {
    if (t) {
      if ("string" == typeof t) {
        ...
        return (
          a
            ? !ie((e = a.image)) && a.pending.push(o)
            : (!e && (e = new Image()),
              (e.onload = e.onerror = ee),
              na.put(t, (e.__cachedImgObj = { image: e, pending: [o] })),
  ...
  function fe(t, e) {
    ...
    for (var o = 0; ; o++) {
      ...
      var s =
        0 === o
          ? de(t, n, e.ascCharWidth, e.cnCharWidth)
          : a > 0
  ...
  function ve(t, e, i, r) {
    ...
    if ((i && (s += i[0] + i[2]), t && r)) {
      ...
      if (null != h && s > h) (t = ""), (a = []);
        ...
        for (
          var u = ce(l - (i ? i[1] + i[3] : 0), e, r.ellipsis, {
              minChar: r.minChar,
  ...
  function _e(t, e) {
    ...
    for (L = 0; L < o.length; L++) {
      for (var p = o[L], g = 0, v = 0, _ = 0; _ < p.tokens.length; _++) {
        ...
        if (
          (w && (k += w[0] + w[2]),
          (z.height = k),
          (z.lineHeight = x(y.textLineHeight, e.textLineHeight, k)),
          (z.textAlign = (y && y.textAlign) || e.textAlign),
          (z.textVerticalAlign = (y && y.textVerticalAlign) || "middle"),
        ...
        if ("string" == typeof T && "%" === T.charAt(T.length - 1))
          ...
          null != P &&
            ...
            (!S || P < A
              ...
              : ((z.text = ue(z.text, P - A, b, c.ellipsis, {
                  minChar: c.minChar
                })),
                (z.textWidth = re(z.text, b)),
                (T = z.textWidth + A)));
    ...
    (i.outerWidth = i.width = m(e.textWidth, h)),
      (i.outerHeight = i.height = m(e.textHeight, s)),
  ...
  function be(t) {
    if (t) {
      ...
      var e = t.textAlign;
      "middle" === e && (e = "center"),
        (t.textAlign = null == e || ca[e] ? e : "left");
      var i = t.textVerticalAlign || t.textBaseline;
      "center" === i && (i = "middle"),
        (t.textVerticalAlign = null == i || fa[i] ? i : "top"),
  ...
  function Te(t, e, i, r, n, a) {
    ...
    t.__styleFont !== h &&
      ((t.__styleFont = h), (l = t.__computedFont = e.font));
    var u = r.textPadding,
      c = t.__textCotentBlock;
    (c && !t.__dirtyText) ||
      (c = t.__textCotentBlock = ve(i, l, u, r.truncate));
    var f = c.outerHeight,
      d = c.lines,
      p = c.lineHeight,
      g = De(f, r, n),
    ...
    var L = r.textStrokeWidth,
      ...
      R = Re(r.textFill);
    if (
      (I && (D && (e.lineWidth = L), B && (e.strokeStyle = I)),
      R &&
        ((s && r.textFill === o.textFill && !o.textBackgroundColor) ||
          (e.fillStyle = R)),
      1 === d.length)
    )
      I && e.strokeText(d[0], w, b), R && e.fillText(d[0], w, b);
    else
      for (var O = 0; O < d.length; O++)
        I && e.strokeText(d[O], w, b), R && e.fillText(d[O], w, b), (b += p);
  }
  function Se(t, e, i, r, n) {
    var a = t.__textCotentBlock;
    (a && !t.__dirtyText) || (a = t.__textCotentBlock = _e(i, r)),
      Me(t, e, a, r, n);
  }
  function Me(t, e, i, r, n) {
    ...
    for (var m = 0; m < i.lines.length; m++) {
      for (
        ...
        Ae(t, e, x, r, T, _, C, "left"), (S -= x.width), (C += x.width), M++;
      for (; P >= 0 && "right" === (x = b[P]).textAlign; )
        Ae(t, e, x, r, T, _, A, "right"), (S -= x.width), (A -= x.width), P--;
      for (C += (a - (C - v) - (y - A) - S) / 2; M <= P; )
        Ae(t, e, (x = b[M]), r, T, _, C + x.width / 2, "center"),
          (C += x.width),
          M++;
      _ += T;
    }
  ...
  function Ae(t, e, i, r, n, a, o, s) {
    ...
    var c = i.textPadding;
    c && ((o = Fe(o, s, c)), (u -= i.height / 2 - c[2] - i.textHeight / 2)),
    ...
    f &&
      ...
      d && (Be(e, "fillStyle", d), e.fillText(i.text, o, u));
  }
  function Pe(t) {
  ...
  function Le(t, e, i, r, n, a, o) {
    var s = i.textBackgroundColor,
      ...
      u = g(s);
    if (
      (Be(e, "shadowBlur", i.textBoxShadowBlur || 0),
      ...
      c ? xe(e, { x: r, y: n, width: a, height: o, r: c }) : e.rect(r, n, a, o),
        e.closePath();
    }
    if (u)
  ...
  function De(t, e, i) {
    ...
    if (i) {
      ...
      if (s instanceof Array)
        (r = i.x + Oe(s[0], i.width)), (n = i.y + Oe(s[1], i.height));
      else {
  ...
  function qe(t, e, i) {
    return (
      va.copy(t.getBoundingRect()),
      t.transform && va.applyTransform(t.transform),
      (_a.width = e),
      (_a.height = i),
      !va.intersect(_a)
    );
  ...
  function Qe(t, e, i) {
    ...
    if (("end" === i && r.clear(), n)) {
      var a = n.type;
      (e.gestureEvent = a),
        t.handler.dispatchToElement({ target: n.target }, a, n.event);
    }
  }
  function $e(t) {
    (t._touching = !0),
  ...
  function ti(t) {
    ...
    an.call(this),
      ...
      (this._touching = !1),
      this._touchTimer,
      (this._gestureMgr = new xa()),
      (this._handlers = {}),
      Je(this),
      Or.pointerEventsSupported
        ? e(Sa, this)
        : (Or.touchEventsSupported && e(ka, this), e(ba, this));
  }
  function ei(t, e) {
    Pa[t] = e;
  }
  ...
  function si(t, e, i, r, n, a) {
    ...
    if (ri(u) && ri(c))
      ...
      if (ri(p)) {
        ...
        (T =
          (-s -
            ((y = y < 0 ? -Da(-y, Fa) : Da(y, Fa)) +
              (m = m < 0 ? -Da(-m, Fa) : Da(m, Fa)))) /
          (3 * o)) >= 0 &&
          T <= 1 &&
          (a[d++] = T);
      } else {
  ...
  function ui(t, e, i, r, n, a, o, s, h, l, u) {
    ...
    for (var y = 0; y < 1; y += 0.05)
      (Ha[0] = ai(t, i, n, o, y)),
        (Ha[1] = ai(e, r, a, s, y)),
        (p = en(Ea, Ha)) < _ && ((c = y), (_ = p));
    _ = 1 / 0;
    for (var m = 0; m < 32 && !(v < Ra); m++)
      (f = c - v),
        (d = c + v),
        (Ha[0] = ai(t, i, n, o, f)),
        (Ha[1] = ai(e, r, a, s, f)),
  ...
  function xi(t, e, i, r, n, a, o, s, h) {
    ...
    if (c % Xa < 1e-4 && c > 1e-4)
      return (
        (s[0] = t - i), (s[1] = e - r), (h[0] = t + i), void (h[1] = e + r)
      );
    if (
      ((Ya[0] = ja(n) * i + t),
      (Ya[1] = qa(n) * r + e),
  ...
  function bi(t, e, i, r, n, a, o, s, h, l, u) {
    ...
    return (
      !(
        ...
        (l < t - c && l < i - c && l < n - c && l < o - c)
      ) && ui(t, e, i, r, n, a, o, s, l, u, null) <= c / 2
    );
  }
  ...
  function Si(t, e, i, r, n, a, o, s, h) {
    ...
    return (
      f < 0 && (f += co), (f >= r && f <= n) || (f + co >= r && f + co <= n)
    );
  }
  ...
  function Li(t, e, i, r, n, a, o, s) {
    ...
    if (l >= 0 && l <= 1) {
      for (var u = 0, c = ci(e, r, a, l), f = 0; f < h; f++) {
        d = 0 === vo[f] || 1 === vo[f] ? 0.5 : 1;
        (p = ci(t, i, n, vo[f])) < o ||
          (vo[f] < l ? (u += c < e ? d : -d) : (u += a < c ? d : -d));
      }
      return u;
    }
    var d = 0 === vo[0] || 1 === vo[0] ? 0.5 : 1,
      p = ci(t, i, n, vo[0]);
    ...
    for (var a = 0, o = 0, s = 0, h = 0, l = 0, u = 0; u < t.length; ) {
      ...
      switch (
        ...
        case fo.C:
          if (i) {
            if (
              bi(o, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], e, r, n)
            )
              return !0;
          } else
            a +=
              Pi(o, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], r, n) ||
              0;
          (o = t[u++]), (s = t[u++]);
          break;
        case fo.Q:
    ...
    for (
      ...
      for (var v = 0; v < p; ) {
        ...
        switch (f) {
          ...
          case "C":
            (u = s.C),
              o.addData(u, d[v++], d[v++], d[v++], d[v++], d[v++], d[v++]),
              (i = d[v - 2]),
              (r = d[v - 1]);
            break;
          case "c":
      ...
      ("z" !== f && "Z" !== f) || ((u = s.Z), o.addData(u), (i = n), (r = a)),
        (e = u);
    }
    return o.toStatic(), o;
  }
  ...
  function Vi(t) {
    for (
      g(t) && (t = new DOMParser().parseFromString(t, "text/xml")),
  ...
  function Xi(t, e) {
    t &&
      ...
      n(e.__inheritedStyle, t.__inheritedStyle));
  }
  function Yi(t) {
  ...
  function Ui(t, e, i, n) {
    ...
    var f = e.style;
    null != a.fill && f.set(l, Gi(a.fill, i)),
      null != a.stroke && f.set(c, Gi(a.stroke, i)),
      u(
        [
          "lineWidth",
          "opacity",
      ...
      (a.textBaseline && "auto" !== a.textBaseline) ||
      ...
      a.lineDash && (e.style.lineDash = b(a.lineDash).split(Uo)),
      f[c] && "none" !== f[c] && (e[c] = !0),
    ...
    if (i) {
      ...
      for (var a = n.length - 1; a > 0; a -= 2) {
        ...
        switch (((r = r || $()), s)) {
          case "translate":
            (o = b(o).split(Uo)),
              et(r, r, [parseFloat(o[0]), parseFloat(o[1] || 0)]);
            break;
          case "scale":
            (o = b(o).split(Uo)),
              rt(r, r, [parseFloat(o[0]), parseFloat(o[1] || o[0])]);
            break;
          case "rotate":
  ...
  function Ji(t, e, i) {
    ...
    return null === r || null === n
      ? [
          (i ? oi : ai)(t.x1, t.cpx1, t.cpx2, t.x2, e),
          (i ? oi : ai)(t.y1, t.cpy1, t.cpy2, t.y2, e)
        ]
      : [
          (i ? fi : ci)(t.x1, t.cpx1, t.x2, e),
          (i ? fi : ci)(t.y1, t.cpy1, t.y2, e)
        ];
  }
  function tr(t) {
  ...
  function or(t, e, i) {
    (!i || ("linear" !== i.type && "radial" !== i.type)) &&
      ("string" == typeof i && i.indexOf("NaN") > -1 && console.log(i),
      t.setAttribute(e, i));
  }
  function sr(t, e, i) {
  ...
  function hr(t, e, i, r) {
    ...
    if (nr(e, i)) {
      ...
      or(t, "stroke", (a = "transparent" === a ? Ps : a)),
        or(
          t,
          "stroke-width",
        ...
        or(t, "paint-order", i ? "stroke" : "fill"),
        or(
          t,
          "stroke-opacity",
        ...
        e.lineDash
          ? (or(t, "stroke-dasharray", e.lineDash.join(",")),
            or(t, "stroke-dashoffset", Ls(e.lineDashOffset || 0)))
          : or(t, "stroke-dasharray", ""),
        e.lineCap && or(t, "stroke-linecap", e.lineCap),
        e.lineJoin && or(t, "stroke-linejoin", e.lineJoin),
        e.miterLimit && or(t, "stroke-miterlimit", e.miterLimit);
    } else or(t, "stroke", Ps);
  }
  function lr(t) {
  ...
  function Pr() {
    if (!Gs && Zs) {
      ...
      t.length < 31
        ? Zs.createStyleSheet().addRule(".zrvml", "behavior:url(#default#VML)")
      ...
      if (e) {
        ...
        (this._dropTarget = o),
          e !== o &&
            (s &&
              o !== s &&
              this.dispatchToElement(H(s, t), "dragleave", t.event),
            o &&
              o !== s &&
              this.dispatchToElement(H(o, t), "dragenter", t.event));
      }
    },
    _dragEnd: function(t) {
      var e = this._draggingTarget;
      e && (e.dragging = !1),
        ...
        this._dropTarget &&
          this.dispatchToElement(H(this._dropTarget, t), "drop", t.event),
  ...
  an.prototype = {
    ...
    one: function(t, e, i, r) {
      ...
      if (("function" == typeof e && ((r = i), (i = e), (e = null)), !i || !t))
        return this;
      (e = W(this, e)), n[t] || (n[t] = []);
      for (var a = 0; a < n[t].length; a++) if (n[t][a].h === i) return this;
      return n[t].push({ h: i, one: !0, query: e, ctx: r || this }), this;
    },
    on: function(t, e, i, r) {
      var n = this._$handlers;
      if (("function" == typeof e && ((r = i), (i = e), (e = null)), !i || !t))
      ...
      (e = W(this, e)), n[t] || (n[t] = []);
      for (var a = 0; a < n[t].length; a++) if (n[t][a].h === i) return this;
      return n[t].push({ h: i, one: !1, query: e, ctx: r || this }), this;
    },
    isSilent: function(t) {
    ...
    findHover: function(t, e, i) {
      for (
        ...
        if (
          ...
          !r[a].ignore &&
          (o = Q(r[a], t, e)) &&
          (!n.topTarget && (n.topTarget = r[a]), o !== ln)
        ) {
          n.target = r[a];
          break;
        }
        ...
        cn.prototype[t] = function(e) {
          ...
          if ("mousedown" === t)
            ...
            if (
              ...
              !this._downPoint ||
              tn(this._downPoint, [e.zrX, e.zrY]) > 4
            )
              return;
  ...
  var fn = "undefined" == typeof Float32Array ? Array : Float32Array,
    ...
    _n = vn.prototype;
  (_n.transform = null),
    (_n.needLocalTransform = function() {
      return (
        at(this.rotation) ||
        at(this.position[0]) ||
        at(this.position[1]) ||
  ...
  (_n.updateTransform = function() {
    ...
    if (i || e) {
      (r = r || $()),
        i ? this.getLocalTransform(r) : pn(r),
        e && (i ? tt(r, t.transform, r) : J(r, t.transform)),
        (this.transform = r);
  ...
  (_n.setLocalTransform = function(t) {
    if (t) {
      var e = t[0] * t[0] + t[1] * t[1],
        ...
        r = this.position,
        n = this.scale;
      at(e - 1) && (e = Math.sqrt(e)),
        at(i - 1) && (i = Math.sqrt(i)),
        t[0] < 0 && (e = -e),
        t[3] < 0 && (i = -i),
        (r[0] = t[4]),
        (r[1] = t[5]),
      ...
      for (var r in e)
        if (e.hasOwnProperty(r)) {
          if (!i[r]) {
            ...
            if (null == n) continue;
            0 !== t && i[r].push({ time: 0, value: Dt(n) });
          }
  ...
  "undefined" != typeof window &&
    (Rn = Math.max(window.devicePixelRatio || 1, 1));
  var On = Rn,
    Fn = function() {},
    En = Fn,
    Hn = function() {
  ...
  (Ht.prototype = {
    ...
    union: function(t) {
      var e = Vn(t.x, this.x),
        i = Vn(t.y, this.y);
      (this.width = qn(t.x + t.width, this.x + this.width) - e),
        (this.height = qn(t.y + t.height, this.y + this.height) - i),
        (this.x = e),
        (this.y = i);
    },
      ...
      return function(n) {
        if (n) {
          (t[0] = i[0] = this.x),
            ...
            Nn(i, i, n),
            Nn(r, r, n),
            (this.x = Vn(t[0], e[0], i[0], r[0])),
            (this.y = Vn(t[1], e[1], i[1], r[1]));
  ...
  (jn.prototype = {
    ...
    _doAdd: function(t) {
      ...
      e &&
        e !== t.__storage &&
        (e.addToStorage(t), t instanceof jn && t.addChildrenToStorage(e)),
        i && i.refresh();
    },
    remove: function(t) {
      var e = this.__zr,
      ...
      return n < 0
        ...
        : (r.splice(n, 1),
          ...
          i &&
            (i.delFromStorage(t),
            t instanceof jn && t.delChildrenFromStorage(i)),
          e && e.refresh(),
          this);
    },
    removeAll: function() {
      ...
      for (e = 0; e < i.length; e++)
        (t = i[e]),
          r &&
            (r.delFromStorage(t),
            t instanceof jn && t.delChildrenFromStorage(r)),
          (t.parent = null);
  ...
  Un.prototype = {
    ...
    addRoot: function(t) {
      t.__storage !== this &&
        (t instanceof jn && t.addChildrenToStorage(this),
        this.addToStorage(t),
        this._roots.push(t));
    },
    delRoot: function(t) {
      ...
      if (t instanceof Array)
        ...
        n >= 0 &&
          ...
          t instanceof jn && t.delChildrenFromStorage(this));
      }
    },
  ...
  $n.prototype = {
    ...
    getGradient: function(t, e, i) {
      for (
        var r = ("radial" === e.type ? Qt : Zt)(t, e, i),
          n = e.colorStops,
          a = 0;
        a < n.length;
        a++
  ...
  var ia = function(t, e, i) {
    var r;
    (i = i || On),
      "string" == typeof t ? (r = Kt(t, e, i)) : v(t) && (t = (r = t).id),
      (this.id = t),
      (this.dom = r);
    var n = r.style;
    n &&
  ...
  ia.prototype = {
    ...
    createBackBuffer: function() {
      var t = this.dpr;
      (this.domBack = Kt("back-" + this.id, this.painter, t)),
    ...
    clear: function(t, e) {
      ...
      if (
        ...
        e.colorStops
          ? ((l =
              e.__canvasGradient ||
              $n.getGradient(r, e, { x: 0, y: 0, width: n, height: a })),
            (e.__canvasGradient = l))
          : e.image && (l = ea.prototype.getCanvasPattern.call(e, r)),
          r.save(),
          (r.fillStyle = l || e),
          r.fillRect(0, 0, n, a),
          r.restore();
  ...
  var ca = { left: 1, right: 1, center: 1 },
    fa = { top: 1, bottom: 1, middle: 1 },
    da = [
  ...
  (ga.prototype = {
    ...
    drawRectText: function(t, e) {
      ...
      if ((null != r && (r += ""), Ee(r, i))) {
        ...
        i.transformText
          ? this.setTransform(t)
          : n && (pa.copy(e), pa.applyTransform(n), (e = pa)),
          ke(this, t, r, i, e),
          t.restore();
      }
    }
    ...
    (He.prototype = {
      ...
      attrKV: function(t, e) {
        "style" !== t
          ? Wn.prototype.attrKV.call(this, t, e)
          : this.style.set(e);
      },
  ...
  var va = new Ht(0, 0, 0, 0),
    ...
    ya = function(t, e, i) {
      ...
      (this._opts = i = r({}, i || {})),
        (this.dpr = i.devicePixelRatio || On),
        (this._singleCanvas = n),
        (this.root = t);
      var a = t.style;
      a &&
        ((a["-webkit-tap-highlight-color"] = "transparent"),
        (a["-webkit-user-select"] = a["user-select"] = a[
  ...
  ya.prototype = {
    ...
    refreshHover: function() {
      var t = this._hoverElements,
        ...
        i = this._hoverlayer;
      if ((i && i.clear(), e)) {
        Ut(t, this.storage.displayableSortFunc),
    ...
    _doPaintList: function(t, e) {
      ...
      for (var a = !0, o = 0; o < i.length; o++) {
        ...
        for (var v = c; v < s.__endIndex; v++) {
          var _ = t[v];
          if (
            (this._doPaintEl(_, s, e, l),
            (_.__dirty = _.__dirtyText = !1),
            f && Date.now() - d > 15)
          )
            break;
        }
    ...
    _doPaintEl: function(t, e, i, r) {
      ...
      if (
        ...
        0 !== t.style.opacity &&
        (!a || a[0] || a[3]) &&
        (!t.culling || !qe(t, this._width, this._height))
      ) {
        var o = t.__clipPaths;
        (r.prevElClipPaths && !je(o, r.prevElClipPaths)) ||
          (r.prevElClipPaths &&
            (e.ctx.restore(), (r.prevElClipPaths = null), (r.prevEl = null)),
          o && (n.save(), Xe(o, n), (r.prevElClipPaths = o))),
    ...
    getLayer: function(t, e) {
      ...
      return (
        r ||
          (((r = new ia("zr_" + t, this, this.dpr)).zlevel = t),
          (r.__builtin__ = !0),
    ...
    _updateLayerStatus: function(t) {
      ...
      for (var i = null, r = 0, n = 0; n < t.length; n++) {
        ...
        o.incremental
          ...
          a.__builtin__ ||
            En("ZLevel " + s + " has been used by unkown layer " + a.id),
          a !== i &&
            ((a.__used = !0),
    ...
    configLayer: function(t, e) {
      if (e) {
        ...
        for (var n = 0; n < this._zlevelList.length; n++) {
          ...
          (a !== t && a !== t + 0.01) || i(this._layers[a], r[t], !0);
        }
      }
    },
    delLayer: function(t) {
    ...
    pathToImage: function(t, e) {
      ...
      (t.position = [u - n.x, f - n.y]),
        ...
        t.updateTransform(),
        t && t.brush(r);
      var _ = new We({ style: { x: 0, y: 0, image: i } });
      return (
        null != v.position && (_.position = t.position = v.position),
        null != v.rotation && (_.rotation = t.rotation = v.rotation),
        null != v.scale && (_.scale = t.scale = v.scale),
        _
      );
    }
  };
  ...
  var wa = {
    ...
    Ma = {
      ...
      touchstart: function(t) {
        ((t = j(this.dom, t)).zrByTouch = !0),
          (this._lastTouchMoment = new Date()),
          Qe(this, t, "start"),
          Ma.mousemove.call(this, t),
      ...
      touchend: function(t) {
        ((t = j(this.dom, t)).zrByTouch = !0),
          ...
          +new Date() - this._lastTouchMoment < 300 && Ma.click.call(this, t),
          $e(this);
      },
  ...
  var Aa = !Or.canvasSupported,
    ...
    za = function(t, e, i) {
      ...
      (this.handler = new cn(n, o, s, o.root)),
        (this.animation = new ma({ stage: { update: f(this.flush, this) } })),
  ...
  (lo.prototype = {
    ...
    lineTo: function(t, e) {
      var i =
        so(t - this._xi) > this._ux ||
        so(e - this._yi) > this._uy ||
        this._len < 5;
      return (
    ...
    arc: function(t, e, i, r, n, a) {
      return (
        this.addData($a.A, t, e, i, i, r, n - r, 0, a ? 0 : 1),
    ...
    _dashedBezierTo: function(t, e, i, r, n, a) {
      ...
      for (f < 0 && (f = c + f), f %= c, o = 0; o < 1; o += 0.1)
        (s = _(g, t, i, n, o + 0.1) - _(g, t, i, n, o)),
          (h = _(v, e, r, a, o + 0.1) - _(v, e, r, a, o)),
          (y += oo(s * s + h * h));
      for (; m < x && !((w += d[m]) > f); m++);
      for (o = (w - f) / y; o <= 1; )
        (l = _(g, t, i, n, o)),
    ...
    toStatic: function() {
      var t = this.data;
      t instanceof Array &&
        ((t.length = this._len), ho && (this.data = new Float32Array(t)));
    },
    getBoundingRect: function() {
      (Ka[0] = Ka[1] = to[0] = to[1] = Number.MAX_VALUE),
        (Ja[0] = Ja[1] = eo[0] = eo[1] = -Number.MAX_VALUE);
      for (
        var t = this.data, e = 0, i = 0, r = 0, n = 0, a = 0;
        a < t.length;
        ...
        switch ((1 == a && ((r = e = t[a]), (n = i = t[a + 1])), o)) {
          ...
          case $a.L:
            ...
            break;
          case $a.C:
            yi(e, i, t[a++], t[a++], t[a++], t[a++], t[a], t[a + 1], to, eo),
              (e = t[a++]),
              (i = t[a++]);
            break;
          case $a.Q:
            mi(e, i, t[a++], t[a++], t[a], t[a + 1], to, eo),
              (e = t[a++]),
              (i = t[a++]);
            break;
          case $a.A:
            var s = t[a++],
              ...
              f = t[a++] + c,
              d = (t[a++], 1 - t[a++]);
            1 == a && ((r = no(c) * l + s), (n = ao(c) * u + h)),
              xi(s, h, l, u, c, f, d, to, eo),
              (e = no(f) * l + s),
              (i = ao(f) * u + h);
            break;
          case $a.R:
      ...
      return (
        0 === a && (Ka[0] = Ka[1] = Ja[0] = Ja[1] = 0),
        new Ht(Ka[0], Ka[1], Ja[0] - Ka[0], Ja[1] - Ka[1])
      );
    },
  ...
  (Ri.prototype = {
    ...
    brush: function(t, e) {
      ...
      h
        ...
        : u && (t.fillStyle = yo.call(o, t)),
        l
          ? (t.strokeStyle = this._strokeGradient)
          : c && (t.strokeStyle = yo.call(s, t));
      var d = i.lineDash,
        p = i.lineDashOffset,
        g = !!t.setLineDash,
      ...
      if (
        (r.setScale(v[0], v[1]),
        this.__dirtyPath || (d && !g && n)
          ? (r.beginPath(t),
            d && !g && (r.setLineDash(d), r.setLineDashOffset(p)),
    ...
    contain: function(t, e) {
      ...
      if (((t = i[0]), (e = i[1]), r.contain(t, e))) {
        ...
        if (n.hasStroke()) {
          ...
          if (
            s > 1e-10 &&
            (n.hasFill() || (o = Math.max(o, this.strokeContainThreshold)),
            Ii(a, o / s, t, e))
          )
            return !0;
        }
    ...
    attrKV: function(t, e) {
      "shape" === t
        ...
        : He.prototype.attrKV.call(this, t, e);
    },
    setShape: function(t, e) {
      var i = this.shape;
      if (i) {
        if (v(t)) for (var r in t) t.hasOwnProperty(r) && (i[r] = t[r]);
        else i[t] = e;
        this.dirty(!0);
      }
      return this;
    ...
    getLineScale: function() {
      ...
      return t && mo(t[0] - 1) > 1e-10 && mo(t[3] - 1) > 1e-10
        ? Math.sqrt(mo(t[0] * t[3] - t[2] * t[1]))
        : 1;
    }
  }),
    ...
    getBoundingRect: function() {
      ...
      if ((this.__dirty && we(t), !this._rect)) {
        ...
        if (
          ((i.x += t.x || 0),
          (i.y += t.y || 0),
          Ie(t.textStroke, t.textStrokeWidth))
        ) {
  ...
  var Fo = Ri.extend({
    ...
    No = function(t, e) {
      ...
      for (a = 0; a < o; a++) {
        ...
        var p = f * f,
          g = f * p;
        r.push([
          Wi(s[0], d[0], h[0], l[0], f, p, g),
          Wi(s[1], d[1], h[1], l[1], f, p, g)
        ]);
      }
      return r;
    },
    Vo = function(t, e, i, r) {
      ...
      for (var f = 0, d = t.length; f < d; f++) {
        ...
        var y = C([], p, u),
          m = C([], p, c);
        r && (F(y, y, o), O(y, y, s), F(m, m, o), O(m, m, s)),
          h.push(y),
          h.push(m);
      }
  ...
  (Yo.prototype = { constructor: Yo }), s(Yo, Xo);
  var Uo = /[\s,]+/;
  (qi.prototype.parse = function(t, e) {
    ...
    return (
      e.ignoreRootClip ||
        null == a ||
        null == o ||
        r.setClipPath(new Eo({ shape: { x: 0, y: 0, width: a, height: o } })),
      { root: r, width: a, height: o, viewBoxRect: h, viewBoxTransform: l }
    );
  }),
    (qi.prototype._parseNode = function(t, e) {
      ...
      for (var s = t.firstChild; s; )
        1 === s.nodeType && this._parseNode(s, r),
          3 === s.nodeType && this._isText && this._parseText(s, r),
          (s = s.nextSibling);
      "defs" === i
        ? (this._isDefine = !1)
  ...
  var Go = {
      ...
      polyline: function(t, e) {
        ...
        return r && (r = Yi(r)), new jo({ shape: { points: r || [] } });
      },
      image: function(t, e) {
        var i = new We();
        return (
  ...
  (Ki.prototype.incremental = !0),
    (Ki.prototype.clearDisplaybles = function() {
      (this._displayables = []),
        (this._temporaryDisplayables = []),
        (this._cursor = 0),
        this.dirty(),
  ...
  (Ki.prototype.getBoundingRect = function() {
    if (!this._rect) {
      for (
        var t = new Ht(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0;
        e < this._displayables.length;
        e++
      ) {
        var i = this._displayables[e],
          r = i.getBoundingRect().clone();
        i.needLocalTransform() && r.applyTransform(i.getLocalTransform(es)),
          t.union(r);
      }
      this._rect = t;
    }
  ...
  var is = Ri.extend({
      ...
      buildPath: function(t, e) {
        ...
        if (i && !(i < 2)) {
          ...
          for (var h = 0, l = i - 1; h < l; h++)
            (s += o), t.lineTo(r + a * ls(s), n + a * hs(s));
          t.closePath();
        }
      }
    }),
      ...
      buildPath: function(t, e) {
        ...
        for (var u = 0, c = a.length; u < c; u++) {
          ...
          for (var f = 0; f <= 360 * s; f++)
            (i = n * fs((((o / s) * f) % 360) * ps) * ds(f * ps) + h),
              (r = n * fs((((o / s) * f) % 360) * ps) * fs(f * ps) + l),
              t.lineTo(i, r);
        }
      }
    }),
    ...
    _s = Ri.extend({
      ...
      brush: (function(t) {
        return Or.browser.ie && Or.browser.version >= 11
          ? function() {
              var e,
                i = this.__clipPaths,
                r = this.style;
              if (i)
                for (var n = 0; n < i.length; n++) {
                  ...
                  if (
                    ...
                    for (h = 0; h < vs.length; h++)
                      (vs[h][2] = r[vs[h][0]]), (r[vs[h][0]] = vs[h][1]);
                    e = !0;
                    break;
                  }
                }
      ...
      buildPath: function(t, e) {
        ...
        if (!(e.location && o <= s)) {
          var f,
            d = 0,
            p = 1;
          (i = (o + c * s) * bs(0) - c * h * bs(0) + l),
            (r = (o + c * s) * ks(0) - h * ks(0) + u),
            t.moveTo(i, r);
          do {
            d++;
          } while ((s * d) % (o + c * s) != 0);
          do {
            (f = (Math.PI / 180) * p),
              (n = (o + c * s) * bs(f) - c * h * bs((o / s + c) * f) + l),
              (a = (o + c * s) * ks(f) - h * ks((o / s + c) * f) + u),
              t.lineTo(n, a),
              p++;
  ...
  (Ss.prototype = { constructor: Ss }), s(Ss, Xo);
  ...
  Fs.brush = function(t) {
    ...
    hr(i, e, !1, t),
      ar(i, t.transform),
      null != e.text && Ns(t, t.getBoundingRect());
  };
  var Es = {};
  Es.brush = function(t) {
    var e = t.style,
    ...
    if ((i instanceof HTMLImageElement && (i = i.src), i)) {
      var r = e.x || 0,
        ...
        o = e.height,
        s = t.__svgEl;
      s || ((s = tr("image")), (t.__svgEl = s)),
        i !== t.__imageSrc && (sr(s, "href", i), (t.__imageSrc = i)),
        or(s, "width", a),
        or(s, "height", o),
        or(s, "x", r),
        or(s, "y", n),
    ...
    Ns = function(t, e, i) {
      ...
      if (null != n) {
        ...
        if (
          ...
          or(a, "y", s),
          hr(a, r, !0, t),
          t instanceof Oo || t.style.transformText)
        )
          ar(a, t.transform);
        else {
          ...
          var y = -r.textRotation || 0,
            m = $();
          it(m, m, y),
            et(m, m, (v = [t.transform[4], t.transform[5]])),
            ar(a, m);
        }
        var x = n.split("\n"),
          w = x.length,
        ...
        if (
          ("after-edge" === f
            ? ((k = -i.height + d), g && (k -= g[2]))
            : "middle" === f
            ? ((k = (-i.height + d) / 2), g && (s += (g[0] - g[2]) / 2))
            : g && (k += g[0]),
          ...
          for (M = 0; M < w; M++)
            (C = T[M])
              ...
              : ((C = T[M] = tr("tspan")),
                a.appendChild(C),
                or(C, "alignment-baseline", f),
                or(C, "text-anchor", b)),
              or(C, "x", o),
              or(C, "y", s + M * d + k),
              C.appendChild(document.createTextNode(x[M]));
              ...
              if (f || d) {
                if (
                  (!f || (d && l.newPos < u.newPos)
                    ? ((s = dr(u)), r.pushComponent(s.components, void 0, !0))
                    : ((s = l).newPos++,
                      r.pushComponent(s.components, !0, void 0)),
                  (c = r.extractCommon(s, e, t, i)),
                  s.newPos + 1 >= n && c + 1 >= a)
                )
                  return fr(0, s.components);
                h[i] = s;
              } else h[i] = void 0;
            }
            o++;
  ...
  (pr.prototype.createElement = tr),
    (pr.prototype.getDefs = function(t) {
      var e = this._svgRoot,
    ...
    s(gr, pr),
    (gr.prototype.addWithoutUpdate = function(t, e) {
      if (e && e.style) {
        var i = this;
        u(["fill", "stroke"], function(r) {
          if (
            e.style[r] &&
            ("linear" === e.style[r].type || "radial" === e.style[r].type)
          ) {
            var n,
              a = e.style[r],
              o = i.getDefs(!0);
            a._dom
              ? ((n = a._dom), o.contains(a._dom) || i.addDom(n))
              : (n = i.add(a)),
              i.markUsed(e);
    ...
    (gr.prototype.update = function(t) {
      ...
      pr.prototype.update.call(this, t, function() {
        var i = t.type,
          r = t._dom.tagName;
        ("linear" === i && "linearGradient" === r) ||
        ("radial" === i && "radialGradient" === r)
    ...
    (gr.prototype.markUsed = function(t) {
      if (t.style) {
        var e = t.style.fill;
        e && e._dom && pr.prototype.markUsed.call(this, e._dom),
          (e = t.style.stroke) &&
            e._dom &&
            pr.prototype.markUsed.call(this, e._dom);
      }
    }),
    s(vr, pr),
    (vr.prototype.update = function(t) {
    ...
    (vr.prototype.updateDom = function(t, e, i) {
      if (e && e.length > 0) {
        ...
        if (o.transform && o.parent.invTransform && !i) {
          ...
          tt(o.transform, o.parent.invTransform, o.transform),
            h.brush(o),
            (o.transform = l);
        } else h.brush(o);
    ...
    (vr.prototype.markUsed = function(t) {
      ...
      t.__clipPaths &&
        ...
        u(t.__clipPaths, function(t) {
          t._dom && pr.prototype.markUsed.call(e, t._dom),
            t._textDom && pr.prototype.markUsed.call(e, t._textDom);
        });
    }),
    s(_r, pr),
    (_r.prototype.addWithoutUpdate = function(t, e) {
      if (e && yr(e.style)) {
        var i,
          r = e.style;
        r._shadowDom
          ? ((i = r._shadowDom),
            this.getDefs(!0).contains(r._shadowDom) || this.addDom(i))
          : (i = this.add(e)),
          this.markUsed(e);
  ...
  var js = function(t, e, i, n) {
    ...
    a.setAttribute("xmlns", "http://www.w3.org/2000/svg"),
      ...
      (this.gradientManager = new gr(n, a)),
      (this.clipPathManager = new vr(n, a)),
      (this.shadowManager = new _r(n, a));
  ...
  (js.prototype = {
    ...
    _getDefs: function(t) {
      ...
      return 0 === i.length
        ? t
          ? ((i = e.insertBefore(tr("defs"), e.firstChild)).contains ||
              (i.contains = function(t) {
                var e = i.children;
                if (!e) return !1;
                for (var r = e.length - 1; r >= 0; --r)
    ...
    ei("svg", js);
  var Xs,
    Ys = "urn:schemas-microsoft-com:vml",
    Us = "undefined" == typeof window ? null : window,
    Gs = !1,
    Zs = Us && Us.document;
  if (Zs && !Or.canvasSupported)
    try {
      !Zs.namespaces.zrvml && Zs.namespaces.add("zrvml", Ys),
        (Xs = function(t) {
  ...
  if (!Or.canvasSupported) {
    var rh = 21600,
      ...
      fh = function(t, e, i) {
        ...
        (i = +i),
          isNaN(i) && (i = 1),
          r && ((t.color = sh(r[0], r[1], r[2])), (t.opacity = i * r[3]));
      },
      dh = function(t) {
        var e = _t(t);
        ...
        if (null != r)
          if (r instanceof Xo) {
            ...
            if ("linear" === r.type) {
              ...
              var g = p[0] - d[0],
                v = p[1] - d[1];
              (a = (180 * Math.atan2(g, v)) / Math.PI) < 0 && (a += 360),
                a < 1e-6 && (a = 0);
            } else {
              n = "gradientradial";
              var d = [r.x * u, r.y * c],
      ...
      gh = function(t, e) {
        null != e.lineDash && (t.dashstyle = e.lineDash.join(" ")),
          null == e.stroke ||
            e.stroke instanceof Xo ||
            fh(t, e.stroke, e.opacity);
      },
      vh = function(t, e, i, r) {
        var n = "fill" == e,
        ...
        null != i[e] && "none" !== i[e] && (n || (!n && i.lineWidth))
          ? ((t[n ? "filled" : "stroked"] = "true"),
            i[e] instanceof Xo && lh(t, a),
            a || (a = Ar(e)),
            n ? ph(a, i, r) : gh(a, i),
            hh(t, a))
          : ((t[n ? "filled" : "stroked"] = "false"), lh(t, a));
      },
      _h = [[], [], []],
      yh = function(t, e) {
        var i,
          ...
          switch (((n = p[a++]), (r = ""), (i = 0), n)) {
            ...
            case c:
              ...
              e &&
                ((b = e[4]),
                (k = e[5]),
                (T = Ks(e[0] * e[0] + e[1] * e[1])),
                (S = Ks(e[2] * e[2] + e[3] * e[3])),
                (M = Math.atan2(-e[1] / S, e[0] / T)));
              var C = p[a++],
                A = p[a++],
                P = p[a++],
                L = p[a++],
    ...
    (Ri.prototype.brushVML = function(t) {
      var e = this.style,
        i = this._vmlEl;
      i || ((i = Ar("shape")), ah(i), (this._vmlEl = i)),
        vh(i, "fill", e, this),
        vh(i, "stroke", e, this);
      ...
      this.__dirtyPath &&
        ...
        h.toStatic(),
        (this.__dirtyPath = !1)),
        (i.path = yh(h, this.transform)),
        (i.style.zIndex = uh(this.zlevel, this.z, this.z2)),
        hh(t, i),
        null != e.text
          ? this.drawRectText(t, this.getBoundingRect())
    ...
    (We.prototype.brushVML = function(t) {
      ...
      if (n) {
        ...
        if (
          (this.transform &&
            ((m = this.transform),
            (b = Ks(m[0] * m[0] + m[1] * m[1])),
            (k = Ks(m[2] * m[2] + m[3] * m[3])),
            (w = m[1] || m[2])),
          w)
        ) {
          var T = [l, u],
        ...
        if (_) {
          if (e && i)
            (B.width = $s((b * e * c) / d) + "px"),
              (B.height = $s((k * i * f) / p) + "px");
          else {
            var I = new Image(),
              O = this;
            (I.onload = function() {
          ...
          D ||
            (((D = Zs.createElement("div")).style.overflow = "hidden"),
            (this._cropEl = D));
          var F = D.style;
          (F.width = $s((c + (g * c) / d) * b)),
            (F.height = $s((f + (v * f) / p) * k)),
            (F.filter =
              ...
              ((-v * f) / p) * k +
              ")"),
            D.parentNode || y.appendChild(D),
            z.parentNode != D && D.appendChild(z);
        } else
          (B.width = $s(b * c) + "px"),
            (B.height = $s(k * f) + "px"),
            y.appendChild(z),
            D && D.parentNode && (y.removeChild(D), (this._cropEl = null));
        var E = "",
          H = r.opacity;
        H < 1 && (E += ".Alpha(opacity=" + $s(100 * H) + ") "),
          (E +=
            "progid:DXImageTransform.Microsoft.AlphaImageLoader(src=" +
            n +
            ", SizingMethod=scale)"),
          (B.filter = E),
          (y.style.zIndex = uh(this.zlevel, this.z, this.z2)),
          hh(t, y),
    ...
    !(function(t, e) {
      ...
      var i = Zs;
      xh ||
        (((xh = i.createElement("div")).style.cssText =
          "position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;"),
        Zs.body.appendChild(xh));
      try {
        xh.style.font = e;
      } catch (t) {}
      return (
        (xh.innerHTML = ""),
        xh.appendChild(i.createTextNode(t)),
        { width: xh.offsetWidth }
      );
    });
    for (
      var Sh = new Ht(), Mh = [ga, He, We, Ri, Oo], Ch = 0;
      Ch < Mh.length;
      Ch++
    ) {
      ...
      (Ah.drawRectText = function(t, e, i, r) {
        ...
        if ((null != a && (a += ""), a)) {
          ...
          if ((_ && !r && (Sh.copy(e), Sh.applyTransform(_), (e = Sh)), r))
            (c = e.x), (f = e.y);
          else {
            var y = n.textPosition,
              m = n.textDistance;
            if (y instanceof Array)
              (c = e.x + ch(y[0], e.width)),
                (f = e.y + ch(y[1], e.height)),
                (d = d || "left");
            else {
              var x = le(y, e, m);
              (c = x.x),
          ...
          var w,
            ...
            S = this._textVmlEl;
          S
            ? (b = (w = (k = S.firstChild).nextSibling).nextSibling)
            : ((S = T("line")),
              (w = T("path")),
              (b = T("textpath")),
              (k = T("skew")),
          ...
          _ && r
            ? (R(M, M, _),
              ...
              (k.matrix =
                ...
                _[3].toFixed(3) +
                ",0,0"),
              (k.offset = ($s(M[0]) || 0) + "," + ($s(M[1]) || 0)),
              (k.origin = "0 0"),
              (C.left = "0px"),
              (C.top = "0px"))
            : ((k.on = !1), (C.left = $s(c) + "px"), (C.top = $s(f) + "px")),
            (b.string = oh(a));
          try {
            b.style.font = v;
          } catch (t) {}
          vh(S, "fill", { fill: n.textFill, opacity: n.opacity }, this),
            vh(
              S,
              "stroke",
              {
            ...
            (S.style.zIndex = uh(this.zlevel, this.z, this.z2)),
            hh(t, S);
        }
      }),
